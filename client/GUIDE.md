...
2.  Add a new profile and enter **ALL** details:
    *   **Train Number, From Station, To Station, and Journey Date.**
    *   **Class (e.g., 3A, SL) and Quota (e.g., TATKAL).**
...
## 🚀 Step 3: The Full Automation Process
...
### 2. Automated Search (Main Page)
*   Navigate to the IRCTC Search page.
*   The extension will automatically fill in the **From/To stations**, **Date**, and **Quota**.
*   It will automatically click **Search**.

### 3. Automated Train Selection (Results Page)
*   The extension will find your **Train Number** in the list.
*   It will automatically select your **Class** and click **Book Now**.

### 4. Automated Passenger Entry (The "Magic" Phase)
...
### 5. Automated Review Page
*   The extension will automatically detect the review page and click **Continue**.
*   It will navigate through the confirmation screens until you reach the **Payment Page**.

### 6. Checkout (Manual)
*   On the payment page, select your preferred method (UPI is recommended for speed) and complete the payment manually.
...
*   **Dry Run:** Always perform a test run on a non-Tatkal train for a future date to ensure the fields and navigation are being detected correctly on your machine.
